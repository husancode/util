...
public final class MD5Util {
     ...
     * @return
     */
    public static String calcMD5String(String s) {
     ...
     * @return
     */
    public static byte[] calcMD5(byte[] bytes) {
    ...
    public static void main(String[] args) {
        // String string = "FCATTX462788040";
        String string = "ZUQFAE507659795";
        System.out.println(md5(string));
        System.out.println(md5(md5(string)));
        System.out.println(md5(md5(string) + "www.88075998.com"));
    }
