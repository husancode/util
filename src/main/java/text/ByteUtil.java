...
public final class ByteUtil {
    ...
    /**
     * 转为对应的2进制，8进制，10进制，16进制，32进制字符串，最高位的0省了，注意位数
     * @param bytes
     * @param radix
     * @return
     */
    ...
    public static void main(String[] args) {
        byte[] b = new byte[]{2,1,1,6,7,8};
        System.out.println(toHexString(b));
        String bStr = binary(b, 16);
        int leftZero = b.length*2-bStr.length();
        if(leftZero > 0){
            StringBuilder sb = new StringBuilder(leftZero);
